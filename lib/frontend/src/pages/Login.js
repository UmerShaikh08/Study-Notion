            ...
            <div className="w-11/12 max-w-maxContent flex flex-col-reverse md:flex-row items-center my-auto gap-20 mb-10">
                <div className=" w-11/12 max-w-[450px] font-inter text-richblack-5 flex flex-col  lg:gap-10 mx-auto ">
                    <div className="flex flex-col gap-3">
                        <div className="text-richblack-5 text-3xl font-semibold ">Welcome Back</div>
                        <div>
                    ...
                    <form className="flex flex-col gap-8` gap-8 mt-5" onSubmit={handleSubmit(submitDetails)}>
                        ...
                        <div className="flex flex-col">
                            ...
                            <Link to={"/forgot-password"}>
                                {" "}
                                <div className="text-sm text-right text-blue-200">forgot password</div>{" "}
                            </Link>
                        </div>

                        <button className="bg-yellow-50 text-black py-2  rounded-md cursor-pointer " disabled={loading}>
                            Sing In
                        </button>
                    </form>
                </div>
