        ...
        <OTPInput
          ...
          renderInput={(props) => (
            <input
              ...
              className="w-[38px]  lg:w-[50px] mx-auto border-0 bg-richblack-800 rounded-[0.5rem] text-richblack-5 aspect-square text-center focus:border-0 focus:outline-2 focus:outline-yellow-50"
            />
          )}
        />
        <button
