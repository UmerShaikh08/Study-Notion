...
const InstructorDashboard = () => {
    ...
    console.log("[InstructorDashboard] : course data", course);

    console.log("course", course);

    return course && course.length > 0 ? (
        <div className="flex flex-col gap-3">
            <div className="text-2xl font-semibold text-richblack-5">Hi {user?.firstName} 👋</div>
        ...
        <div className="text-richblack-5 text-2xl text-center">Course Not Found</div>
    );
};
